...
open class ASCollectionViewDelegate: NSObject, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout
{
    ...
    {
        return coordinator?.collectionView(collectionView, shouldSelectItemAt: indexPath) ?? true
    }

    public func collectionView(_ collectionView: UICollectionView, shouldDeselectItemAt indexPath: IndexPath) -> Bool
    {
        return coordinator?.collectionView(collectionView, shouldDeselectItemAt: indexPath) ?? true
    }
